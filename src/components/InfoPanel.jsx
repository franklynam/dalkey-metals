...
export default function InfoPanel({ poi, onClose }) {
  return (
    <div
      className="absolute bottom-1/2 left-1/2 -translate-x-1/2 bg-black/88 backdrop-blur border border-white/15 rounded-[10px] py-4 px-5 text-white shadow-[0_8px_32px_rgba(0,0,0,0.5)] z-[100]"
