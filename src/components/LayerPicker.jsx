...
export const LAYERS = [
  {
    ...
    label: "Satellite",
    preview:
      "linear-gradient(135deg, #3d5a3e 0%, #6b8c5a 40%, #4a7a6b 70%, #2d4a5e 100%)",
  },
  {
    id: "1837-oss",
    label: "1837 OSS",
    preview:
      "linear-gradient(135deg, #d4c5a9 0%, #c8b89a 40%, #b8a882 70%, #a89870 100%)",
  },
];
...
function LayersIcon() {
  return (
    ...
    >
      <path
        d="M10 2L2 6.5l8 4.5 8-4.5L10 2z"
        fill="currentColor"
        opacity="0.6"
      />
      <path
